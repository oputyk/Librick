...
public class UserConverterImpl implements UserConverter {
    ...
    public UserEntity toUserEntity(CredentialsUserDto credentialsUserDto) {
        UserEntity oldUserEntity;
        oldUserEntity = createEntity(null);

        return (UserEntity) converter.toEntity(oldUserEntity, credentialsUserDto);
    }
    ...
    private UserEntity findEntityAndCreateIfDoesntExist(Long id) {
        ...
        if(userEntity == null) {
            userEntity = createEntity(id);
        }

        return userEntity;
    }

    private UserEntity createEntity(Long id) {
